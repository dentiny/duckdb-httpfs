...
void hmac256(EncryptionUtil &encryption_util, const string &message, const_data_ptr_t secret, idx_t secret_len,
             hash_bytes &out) {
	D_ASSERT(CryptoHash::GetDigestSize(CryptoHashFunction::SHA256) == sizeof(hash_bytes));
...
void hmac256(EncryptionUtil &encryption_util, const string &message, hash_bytes secret, hash_bytes &out) {
